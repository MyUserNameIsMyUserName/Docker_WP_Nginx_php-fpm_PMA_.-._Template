...
case ${answer:0:1} in
    y|Y )
        ...
        echo "INFO: Removing directories and contents (addon_files/certs/ addon_files/certs-data/ addon_files/logs/nginx/ mysql/ PUBLIC/)"
        rm -rf addon_files/certs/ addon_files/certs-data/ addon_files/logs/nginx/ mysql/ PUBLIC/
        echo "INFO: Done"
        exit 0;
    ;;
    * )
